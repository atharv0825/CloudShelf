                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-4">
                        <h5 className="fw-bold mb-3 text-gray-500">
                            <img width='100px' src='./src/assets/cloudshelf logo H.png'/>
                        </h5>
                        <p className="opacity-75 text-gray-500">Creating beautiful digital experiences with modern design solutions for forward-thinking
                            companies.</p>
                    ...
                    <div className="col-lg-2 col-md-4">
                        <h6 className="fw-bold mb-3 text-red-500 text-gray-500">Quick Links</h6>
