        ...
        <div>
            <header className='header shadow-md '>
                ...
                <nav className='navbar'>
                    <a className="design" href="/">Home</a>
                    <a className="design" href="/myShelf">My Shelf</a>
                    <a className="design" href='/#pricing'>Plans and Pricing</a>
                    <a className="design" href='#footer'>Contact Us</a>
                    ...
                    isLoggedIn ? (
                        ...
                        < Link to="/login" className="dropdown btn_nav">
