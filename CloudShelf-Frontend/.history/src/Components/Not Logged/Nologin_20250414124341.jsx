...
const Nologin = () => {
    ...
    return (
        <div className='mt-40'>
            ...
            <div className='conatainer_image'>
                <div className='image-row'>
                    <img src='./src/assets/college1.jpg' className='logo' />
                    <img src='./src/assets/college2.jpg' className='logo' />
                    <img src='./src/assets/college3.jpg' className='logo' />
                </div>
            </div>
        </div>
    )
