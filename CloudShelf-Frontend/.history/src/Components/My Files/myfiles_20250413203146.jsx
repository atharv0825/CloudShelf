...
const MyFiles = () => {
    ...
    return (
        <div className="container my-5">
            ...
            <div className="row">
                <div className="col-md-4 mb-4">
                    <div className="mycard" style={{ backgroundImage: "url('https://picsum.photos/id/4/800/600')" }}>
                        <h3>Random Card 4</h3>
                        <p>This is a randomly generated mycard.</p>
                    </div>
                </div>
                <div className="col-md-4 mb-4">
                    <div className="mycard" style={{ backgroundImage: "url('https://picsum.photos/id/5/800/600')" }}>
                        <h3>Random Card 5</h3>
                        <p>This is a randomly generated mycard.</p>
                    </div>
                </div>
                <div className="col-md-4 mb-4">
                    <div className="mycard" style={{ backgroundImage: "url('https://picsum.photos/id/6/800/600')" }}>
                        <h3>Random Card 6</h3>
                        <p>This is a randomly generated mycard.</p>
                    </div>
                </div>
