...
const Footer = () => {
    return (
        <footer id='footer' className="gradient-footer text-white py-5">
            <div className="container">
                <div className="row g-4">

                    <div className="col-lg-4">
                        <h5 className="fw-bold mb-3 text-gray-500">
                            <img width='200px'  src='./src/assets/cloudshelf logo H.png'/>
                        </h5>
                        <p className="opacity-75 text-gray-500">Got a question, suggestion, or need help? We’d love to hear from you!</p>
                    ...
                    <div className="col-lg-2 col-md-4">
                        <h6 className="fw-bold mb-3  text-gray-500">Quick Links</h6>
                    ...
                    <div className="col-lg-2 col-md-4">
                        <h6 className="fw-bold mb-3 text-gray-500">Resources</h6>
                        <ul className="list-unstyled">
                    ...
                    <div className="col-lg-4">
                        <h6 className="fw-bold mb-3 text-gray-500">Newsletter</h6>
                        <p className="opacity-75 text-gray-500">Stay updated with our latest news and updates.</p>
                ...
                <div className="row align-items-center">
                    <div className="col-md-6 text-center text-md-start">
                        <small className="opacity-75 text-gray-500">© 2025 cloudshelf. All rights reserved.</small>
                    </div>
                    <div className="col-md-6 text-center text-md-end mt-3 mt-md-0 text-gray-500">
